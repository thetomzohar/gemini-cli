...
| Context Compression Token Threshold  | `model.contextCompressionTokenThreshold` | Fraction of the model token limit at which context compression activates (0.0–1.0). Default 0.1 means compression runs only when history exceeds 10% of the context window. | `0.1`                                          |
| Cloud Context Compression            | `model.compressCloud`                    | Enable cloud model context compression for files.                                                                                                                           | `false`                                        |
| Local Context Compression            | `model.localContextCompression`          | Enable local model context compression for files.                                                                                                                           | `false`                                        |
| Local Context Compression Model URL  | `model.localContextCompressionModelUrl`  | The URL for the local context compression model.                                                                                                                            | `"http://localhost:11434/v1/chat/completions"` |
| Local Context Compression Model Name | `model.localContextCompressionModelName` | The name of the local context compression model.                                                                                                                            | `"qwen2.5-coder"`                              |
